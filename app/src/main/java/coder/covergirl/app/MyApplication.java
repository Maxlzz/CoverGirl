package coder.covergirl.app;

import android.app.Application;

import java.util.concurrent.TimeUnit;

import coder.covergirl.app.exception.LocalFileHandler;
import coder.covergirl.util.LogUtil;
import coder.covergirl.util.ToastUtil;
